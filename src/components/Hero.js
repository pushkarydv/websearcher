...
export default function Hero() {
  return (
    <>
      <div className="pl-6 md:pl-12 pr-8 pt-32 pb-10 md:pt-44 md:pb-6 text-5xl lg:text-7xl xl:pl-20 xl:pb-10 text-slate-300">
        Let's rank your app top in search
      </div>
      <div className="flex flex-col md:flex-row">
        <div className="basis-2/3 pl-6 md:pl-12 py-6  text-5xl text-slate-300 xl:pl-20 xl:text-6xl 2xl:text-7xl xl:pb-14 xl:pt-24 pb-16">
          Generate{" "}
